...
struct ThemeUIHelper {
    ...
    static func style(for theme: String) -> ThemeStyle {
        ...
        case "parody": return .init(name: "Parodia", color: .yellow, icon: "face.smiling")
        ...
        case "showbiz": return .init(name: "Espectáculo", color: .yellow, icon: "star.fill")
        ...
        case "gag humor": return .init(name: "Comedia", color: .yellow, icon: "face.smiling")
        ...
        case "performing arts": return .init(name: "Artes Escénicas", color: .yellow, icon: "theatermasks.fill")
